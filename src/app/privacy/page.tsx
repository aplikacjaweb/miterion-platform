  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose max-w-none space-y-6 text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">3a. Profiling</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">5. Analytics</h2>
          <h3 className="text-xl font-semibold text-navy mt-4 mb-2">Use of Google Analytics</h3>
          <p>We use Google Analytics, a web analysis service provided by Google Ireland Limited ("Google"). Google Analytics uses "cookies," which are text files placed on your computer, to help the website analyze how users use the site. The information generated by the cookie about your use of the website (including your IP address) will be transmitted to and stored by Google on servers in the United States.</p>
          <h3 className="text-xl font-semibold text-navy mt-4 mb-2">Your Consent</h3>
          <p>In accordance with GDPR and ePrivacy regulations, we only utilize Google Analytics after you have explicitly provided your consent via our Cookie Consent Banner. You have the right to withdraw this consent at any time by clearing your browser's local storage or by adjusting your preferences through our cookie settings.</p>
          <h3 className="text-xl font-semibold text-navy mt-4 mb-2">Data Processing & Anonymization</h3>
          <p>We have configured Google Analytics to ensure that your IP address is anonymized (IP masking) before it is transmitted. This ensures that your personal data is handled with the highest level of privacy.</p>
          <h3 className="text-xl font-semibold text-navy mt-4 mb-2">Opt-Out</h3>
          <p>If you wish to prevent your data from being used by Google Analytics, you can install the Google Analytics Opt-out Browser Add-on, which is available for all modern web browsers.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">6. Sharing Your Personal Data</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">7. International Data Transfers</h2>
          <p>Some of our third-party service providers, such as Google Analytics and Facebook Pixel, may transfer data outside the European Union (EU), particularly to the United States. In such cases, we ensure that appropriate safeguards are in place to protect your personal data, such as reliance on <strong>Standard Contractual Clauses (SCCs)</strong> approved by the European Commission, or the <strong>EU-U.S. Data Privacy Framework (DPF)</strong> for providers certified under this program, or other legally recognized mechanisms providing an adequate level of data protection.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">8. Data Retention</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">9. Your GDPR Rights</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">10. Security Measures</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">11. Contact Details for the Supervisory Authority</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">12. Governing Law</h2>
          <p>This Privacy Policy and all matters relating to your personal data are governed by the laws of Poland, including the GDPR and the Polish Act on the Protection of Personal Data.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold text-navy mb-3">13. Changes to This Privacy Policy</h2>
