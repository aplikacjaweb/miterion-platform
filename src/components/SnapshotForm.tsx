            ...
            {preview.error ? (
              ...
              <>
                ...
                <div className="space-y-6 mt-10">
                  ...
                  {/* Card 1: Generate Free Landscape Snapshot */}
                  <div className="bg-gray-50 p-6 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center text-center">
                    <h4 className="text-xl font-semibold mb-3 text-gray-800">Generate Free Landscape Snapshot</h4>
                    ...
                    <form onSubmit={handleSubmitUnlock(onGeneratePdf)} noValidate className="w-full max-w-sm">
                      <input
                        ...
                        type="email"
                        placeholder="Enter your email to generate report"
                      ...
                      >
                        {isPdfGenerating ? 'Generating PDF...' : 'Generate Snapshot Report'}
                      </Button>
                    </form>
