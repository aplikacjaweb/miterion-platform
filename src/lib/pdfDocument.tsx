...
export function buildPdfDocument(data: PdfDocumentData) {
 ...
 <Text style={styles.paragraph}>Indication: {data.indication}</Text>
 <Text style={styles.paragraph}>Phase: {data.phase}</Text>
 <Text style={styles.paragraph}>Geography: {data.country_name}</Text>

 <View style={styles.metrics}>
 <View style={styles.metricCard}>
 <Text style={styles.metricTitle}>Total Trials</Text>
 <Text style={styles.metricValue}>{data.preview?.totalTrials ?? 0}</Text>
 </View>
 <View style={styles.metricCard}>
 <Text style={styles.metricTitle}>Recruiting Trials</Text>
 <Text style={styles.metricValue}>
 {data.preview?.recruitingTrials ?? 0} ({data.preview?.recruitingPct ?? 0}%)
 </Text>
 </View>
 <View style={styles.metricCard}>
 <Text style={styles.metricTitle}>Recruitment Competition</Text>
 <Text style={styles.metricValue}>
 {(data.preview?.totalTrials ?? 0) <= 3
 ? 'LOW'
 : (data.preview?.totalTrials ?? 0) <= 10
 ? 'MEDIUM'
 : 'HIGH'}
 </Text>
 </View>
 ...
 {study.phases?.length ? study.phases.join(', ') : 'N/A'}
 </Text>
 <Text style={styles.tableCol}>{study.overallStatus}</Text>
 <Text style={styles.tableCol}>
 {study.countries?.length ? study.countries.join(', ') : 'N/A'}
 </Text>
 </View>
 ))}
 </View>
